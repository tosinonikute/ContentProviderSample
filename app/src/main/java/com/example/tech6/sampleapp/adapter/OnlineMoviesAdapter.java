...
/*
    OnlineMoviesAdapter Gets called if User is online.
 */
...
public class OnlineMoviesAdapter extends BaseAdapter {


    OnlineDataFragment F1= new OnlineDataFragment();
    ArrayList<Movies> list = F1.getList();

    private Context mContext;

    public OnlineMoviesAdapter(Context c) {
        mContext = c;
    }
